...
napoleon_custom_sections = ['Definitions', 'Fit procedure', 'Model selection', 'Slit openings', 'Time calculations']
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/scippneutron/",
...
htmlhelp_basename = 'scippneutrondoc'

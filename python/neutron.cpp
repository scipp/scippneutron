...
template <class T> void bind_beamline(py::module &m) {
  ...
  m.def(
      "source_position", [](const T& self) { return source_position(self.meta()); },
      R"(
  ...
  m.def(
      "sample_position", [](const T& self) { return sample_position(self.meta()); },
      R"(
  ...
  m.def(
      "incident_beam", [](const T& self) { return incident_beam(self.meta()); }, R"(
  ...
  m.def(
      "scattered_beam", [](const T& self) { return scattered_beam(self.meta()); }, R"(
...
template <class T> void bind_convert(py::module &m) {
  ...
  m.def(
      ...
      [](T data, const Dim origin, const Dim target, const bool scatter) {
        return py::cast(
            convert(std::move(data), origin, target,
                    scatter ? ConvertMode::Scatter : ConvertMode::NoScatter));
      },
